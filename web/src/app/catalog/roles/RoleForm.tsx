    ...
    <Card className="max-w-xl p-5">
      <form action={action} className="space-y-4">
        <Field label="Name" htmlFor="name" required>
          <Input id="name" name="name" defaultValue={defaults?.name ?? ""} required placeholder="e.g. Principal Investigator" />
        </Field>
        ...
        <div className="flex gap-2">
          ...
          <Link href="/catalog/roles" className="px-3 py-1.5 text-sm text-slate-500 hover:text-slate-800">
            Cancel
          </Link>
        </div>
      </form>
